...
export const jobs: Job[] = [
  {
    ...
    description:
      "We are seeking a talented Full-Stack Developer to join our dynamic team in building cutting-edge web applications. The ideal candidate will have experience with both front-end and back-end technologies and be passionate business creating seamless user experiences.",
    responsibilities: [
